...
def genprofiles_operator(og,
    ...
    def generate_TS(U,N,pol_array):
        ...
        policy_VF = np.copy(pol_array[10][0].astype(np.float64))
...
def sortmoments(moments_male, moments_female):
    ...
    moments_sorted = pd.concat(
                        ...
                        moments_male['mean_risky_share_c_wave14_male'],
                        moments_female['mean_risky_share_c_wave14_female'],
                        moments_male['mean_risky_share_c_wave10_male'], 
                        moments_female['mean_risky_share_c_wave10_female'],
