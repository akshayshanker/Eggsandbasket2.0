...
class LifeCycleParams:
        ...
        def __init__(self,
                ...
                Path("/scratch/pv33/ls_model_temp/{}/{}_acc_0/".format(mod_name,self.param_id)).mkdir(parents=True, exist_ok=True)
                pickle.dump(param_dict_new, open("/scratch/pv33/ls_model_temp/{}/{}_acc_0/params.smms".format(mod_name,self.param_id), "wb"))
